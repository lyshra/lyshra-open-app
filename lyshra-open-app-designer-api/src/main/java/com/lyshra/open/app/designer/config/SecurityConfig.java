...
import com.lyshra.open.app.designer.security.JwtAuthenticationFilter;
...
/**
 * Security configuration for the workflow designer API.
 */
@Configuration
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers("/api/v1/validation/**").authenticated()
